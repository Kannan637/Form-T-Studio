...
export default function Home() {
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center p-6 text-center bg-white font-sans selection:bg-black selection:text-white">
      ...
      <div className="w-full max-w-[1200px] mb-12 md:mb-16 lg:mb-20">
        <img
          ...
          className="w-full h-auto max-h-[350px] md:max-h-[600px] lg:max-h-[750px] object-contain mx-auto"
        />
      </div>
      ...
      <div className="flex flex-col items-center gap-5 w-full max-w-2xl px-4">
        ...
        {/* Coming Soon tag */}
        <h2 className="text-sm sm:text-base md:text-lg font-medium tracking-[0.2em] text-gray-800 uppercase">
          Coming Soon
        </h2>
      ...
      <div className="mt-12 md:mt-16">
        <a
          ...
          className="group inline-flex items-center justify-center gap-3 rounded-full border-2 border-black bg-white px-8 py-4 text-sm sm:text-base font-semibold text-black transition-all duration-300 hover:bg-black hover:text-white hover:shadow-xl hover:-translate-y-1"
        >
          <svg
          ...
          <span className="tracking-wide">Follow Us on Instagram</span>
        </a>
      </div>
